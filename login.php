...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $loginObj = new UserLogin($_POST['email'], $_POST['password']);
  $loginObj->login();
}
...
<html
  ...
  <body class="h-full bg-slate-100">
    <div class="flex flex-col justify-center min-h-full py-12 sm:px-6 lg:px-8">
      ...
      <?php if (isset($loginObj->errors['auth-error'])): ?>
        <div class="mt-2 bg-red-500 text-sm text-white rounded-lg p-4" role="alert">
            <span class="font-bold">
                <?= $loginObj->errors['auth-error']; ?>
            </span>
        </div>
      <?php endif; ?>

      <?php if (isset($_SESSION['flash']['register-success'])) : ?>
            ...
            <div>
              ...
              <div class="mt-2">
                <input
                  ...
                  <?php if (isset($loginObj->errors['email'])) : ?>
                      <p class="text-xs text-red-600 mt-2"><?= $loginObj->errors['email']; ?></p>
                  <?php endif; ?>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="mt-2">
                <input
                  ...
                  <?php if (isset($loginObj->errors['password'])) : ?>
                      <p class="text-xs text-red-600 mt-2"><?= $loginObj->errors['password']; ?></p>
                  <?php endif; ?>
              </div>
            </div>
