...
if (!isset($_SESSION['user_id'])) {
  ...
  exit;
} else if ($_SESSION['useremail'] !== 'admin@admin.com') {
  header('Location:../login.php');
  exit;
}

if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  $newCustomerObj = new Customer($_POST['first-name'] . " " . $_POST['last-name'], $_POST['email'], $_POST['password']);
  $newCustomerObj->registerCustomer();
}
                    ...
                    <button
                      ...
                      <span
                        ...
                        <span class="font-medium leading-none text-sky-700"
                          > <?= substr($_SESSION['username'], 0, 2); ?> </span
                        >
                      </span>
                      <!-- <img
      ...
      <main class="-mt-32">
        <div class="px-4 pb-12 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div class="bg-white rounded-lg">
            <form method="POST" action="add_customer.php" novalidate
                  ...
                  <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                      <input
                        ...
                        <?php if (isset($newCustomerObj->errors['name'])) : ?>
                          <p class="text-xs text-red-600 mt-2"><?= $newCustomerObj->errors['name']; ?></p>
                        <?php endif; ?>
                    </div>
                  </div>
                  ...
                  <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                      <input
                        ...
                        autocomplete="email"
                        class="block w-full p-2 text-gray-900 border-0 rounded-md shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6" />
                      <?php if (isset($newCustomerObj->errors['email'])) : ?>
                        <p class="text-xs text-red-600 mt-2"><?= $newCustomerObj->errors['email']; ?></p>
                      <?php endif; ?>
                    </div>
                  </div>
                  ...
                  <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                      <input
                        ...
                        class="block w-full p-2 text-gray-900 border-0 rounded-md shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6" />
                      <?php if (isset($newCustomerObj->errors['password'])) : ?>
                          <p class="text-xs text-red-600 mt-2"><?= $newCustomerObj->errors['password']; ?></p>
                      <?php endif; ?>
                    </div>
                  </div>
                </div>
