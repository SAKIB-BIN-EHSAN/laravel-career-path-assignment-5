  ...
  <body class="h-full">
    <div class="min-h-full">
      <div class="bg-emerald-600 pb-32">
        ...
        <?php if (isset($errors['auth-error'])) : ?>
          <div class="mt-2 bg-green-500 text-sm text-white rounded-lg p-4 mx-auto max-w-7xl sm:px-6 lg:px-8" role="success">
        ...
        <?php if (isset($_SESSION['flash']['login-success'])) : ?>
          <div class="mt-2 bg-green-500 text-sm text-white rounded-lg p-4 mx-auto max-w-7xl sm:px-6 lg:px-8" role="success">
              <span class="font-bold">
        ...
        <?php if (isset($_SESSION['flash']['transfer-success'])) : ?>
          <div class="mt-2 bg-green-500 text-sm text-white rounded-lg p-4 mx-auto max-w-7xl sm:px-6 lg:px-8" role="success">
              <span class="font-bold">
                  <?= flashMessage('transfer-success'); ?>
              </span>
          </div>
        <?php endif; ?>

        <?php if (isset($_SESSION['flash']['deposit-success'])) : ?>
          <div class="mt-2 bg-green-500 text-sm text-white rounded-lg p-4 mx-auto max-w-7xl sm:px-6 lg:px-8" role="success">
              <span class="font-bold">
                  <?= flashMessage('deposit-success'); ?>
              </span>
          </div>
        <?php endif; ?>

        <?php if (isset($_SESSION['flash']['withdraw-success'])) : ?>
          <div class="mt-2 bg-green-500 text-sm text-white rounded-lg p-4 mx-auto max-w-7xl sm:px-6 lg:px-8" role="success">
              <span class="font-bold">
                  <?= flashMessage('withdraw-success'); ?>
              </span>
          </div>
        <?php endif; ?>
            ...
            <div class="px-4 sm:px-6 lg:px-8">
              <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                  ...
                  <?php if (count($ownTransactions) === 0) { ?>
                  ...
                  <?php if (count($ownTransactions) !== 0) { ?>
                    <p class="mt-2 text-sm text-gray-700">
                      ...
                      sender's email, receiver's email, transaction type, amount and date.
                    </p>
                  <?php } ?>
