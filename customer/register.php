...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  $customerObj = new Customer($_POST['name'], $_POST['email'], $_POST['password']);
            ...
            <div>
              ...
              <div class="mt-2">
                <input
                  ...
                  <?php if (isset($customerObj->errors['name'])) : ?>
                      <p class="text-xs text-red-600 mt-2"><?= $customerObj->errors['name']; ?></p>
                  <?php endif; ?>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="mt-2">
                <input
                  ...
                  <?php if (isset($customerObj->errors['email'])) : ?>
                      <p class="text-xs text-red-600 mt-2"><?= $customerObj->errors['email']; ?></p>
                  <?php endif; ?>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="mt-2">
                <input
                  ...
                  <?php if (isset($customerObj->errors['password'])) : ?>
                      <p class="text-xs text-red-600 mt-2"><?= $customerObj->errors['password']; ?></p>
                  <?php endif; ?>
              </div>
            </div>
